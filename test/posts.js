    ...
    describe("Private Posts Visibility", function () {
        it("Private posts should be hidden from non-admin users", async function () {
            ...
            assert.strictEqual(
                typeof userPosts,
                "object",
                "userPosts should be an object",
            );
            assert.strictEqual(
                Array.isArray(userPosts),
                true,
                "userPosts should be an array",
            );
            ...
            userPosts.forEach((post) => {
                ...
                assert.strictEqual(
                    typeof post.privacy,
                    "string",
                    "post.privacy should be a string",
                );
                // Add more assertions for other properties as needed
            });

            // Additional assertion for the test case
            const hasPrivatePosts = userPosts.some(
                (post) => post.privacy === "private",
            );
            assert.strictEqual(
                hasPrivatePosts,
                false,
                "Non-admin users should not view private posts",
            );
        });
        ...
        it("Admin users should see private posts", async function () {
            ...
            assert.strictEqual(
                typeof adminUserId,
                "number",
                "adminUserId should be a number",
            );

            // Check the type signature of function return
            assert.strictEqual(
                typeof adminUserPosts,
                "object",
                "adminUserPosts should be an object",
            );
            assert.strictEqual(
                Array.isArray(adminUserPosts),
                true,
                "adminUserPosts should be an array",
            );
            ...
            // Additional assertion for the test case
            const hasPrivatePosts = adminUserPosts.some(
                (post) => post.privacy === "private",
            );
            assert.strictEqual(
                hasPrivatePosts,
                true,
                "Admin users should view private posts",
            );
        });
    });
