                        ...
                        categories.create(
                            {
                                ...
                                description:
                                    "Test category made by test script",
                            },
                            next,
                        );
                    },
...
describe("Group membership tests", () => {
    ...
    it("getUserGroups should return 2 groups the user is a member of", async () => {
        ...
        assert(
            memberGroupNames.includes(groupName1),
            "User should be a member of groupName1",
        );
        assert(
            memberGroupNames.includes(groupName2),
            "User should be a member of groupName2",
        );
        assert(
            memberGroupNames.includes(groupName3),
            "User should be a member of groupName3",
        );
    });
    ...
    it("getUserOtherGroups should return 1 group the user is not a member of", async () => {
        ...
        assert(
            otherGroupNames.includes(groupName4),
            "User should not be a member of groupName3",
        );
        assert(
            otherGroupNames.includes(groupName5),
            "User should not be a member of groupName3",
        );
    });
});
